        ...
        <div class="header__wrapper">
            ...
            <ul class="header__list">
                <li class="header__item">
                    <a class="header__link" href="https://github.com/aizireklin/vue-exam/" target="_blank">
                        <p class="header__label">Github репозиторий</p>
                        <svg height="36px" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="512px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
